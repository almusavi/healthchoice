...
# puts coor_dist(lat1, lon1, lat2, lon2)
	...
	def distance(city1, city2)
		url1 = 'https://maps.googleapis.com/maps/api/geocode/json?address=' + city1 + '&key=AIzaSyAaT_k8ZavcjlWgoadxwXK2QzRVEvoGFzw'
		url2 = 'https://maps.googleapis.com/maps/api/geocode/json?address=' + city2 + '&key=AIzaSyAaT_k8ZavcjlWgoadxwXK2QzRVEvoGFzw'
